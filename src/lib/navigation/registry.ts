...
export const NAV_REGISTRY: NavigationRegistryItem[] = [
  ...
  },
  {
    ...
    requiredPermissions: ["settings.grading", "results.view", "exams.view"],
    requireAny: true,
    portalType: "school",
    group: "Academic",
    order: 14,
  ...
  },
  {
    ...
    icon: "CreditCard",
    path: "/finance/reports",
    requiredPermissions: ["bank_reconciliation.view"],
    portalType: "school",
    group: "Finance",
    order: 33,
  },
  {
    ...
    icon: "BarChart3",
    path: "/finance/reports",
    requiredPermissions: ["budgets.view"],
    portalType: "school",
    group: "Finance",
    order: 34,
  },
  ...
  },
  {
    ...
    icon: "BookOpen",
    path: "/my-subjects",
    requiredPermissions: ["sow.view_own"],
    portalType: "school",
    group: "Teacher Portal",
    order: 144,
  },
