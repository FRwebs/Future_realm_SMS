  ...
  return (
    <div className="grid gap-5">
      <ModuleHero
        ...
        description="Country-specific curriculum, assessment, grading scale, and report card templates. Schools consume these during onboarding and customise their own copy — the master library is never edited by schools."
      />
