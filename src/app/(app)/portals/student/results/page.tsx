  ...
  return (
    <div className="portal-page">
      <section className="surface-hero p-6 md:p-7">
        ...
        <h1 className="mt-3 font-[var(--font-heading)] text-[26px] font-black text-[var(--color-text-primary)]">My results</h1>
      ...
      {results.map((result) => (
        <section key={result.id} className="surface-card p-6 print:shadow-none">
          ...
          <div className="mt-5 grid gap-4 text-[13px] text-[var(--color-text-secondary)] md:grid-cols-2">
