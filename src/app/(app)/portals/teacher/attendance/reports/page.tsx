...
export default async function TeacherAttendanceReportsPage() {
  const session = await getServerSession();
  if (!session) return null;
  if (!canAccessPath(session.role, "/portals/teacher/attendance/reports")) {
  ...
  return <TeacherAttendanceClient portal={portal} attendance={attendance} initialTab="insights" />;
}
