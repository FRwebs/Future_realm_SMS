...
type ParentAnnouncement = { id: string; title: string; detail: string; time: string };
...
export default async function ParentAnnouncementsPage() {
  ...
  const announcements = await apiGet<ParentAnnouncement[]>("/api/v1/parent-portal/announcements");
  ...
  return (
    <div className="portal-page">
      <section className="surface-hero p-6 md:p-7">
        ...
        <h1 className="mt-3 font-[var(--font-heading)] text-[26px] font-black text-[var(--color-text-primary)]">Family announcements</h1>
      </section>
